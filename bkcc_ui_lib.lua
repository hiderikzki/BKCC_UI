...
do
    ...
    Utility.SaveConfig = function(Config)
        writefile(
            "Boykisser/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local Config = HttpService:JSONDecode(readfile("Boykisser/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Logo = Utility.AddImage("Boykisser/Assets/UI/Logo2.png", "https://github.com/hiderikzki/BKCC_UI/blob/main/logo.png?raw=true")
        --
        ...
        --
        Utility.AddFolder("Boykisser")
        Utility.AddFolder("Boykisser/Caches")
        Utility.AddFolder("Boykisser/Assets")
        Utility.AddFolder("Boykisser/Assets/UI")
        Utility.AddFolder("Boykisser/Configs")
        Utility.AddFolder("Boykisser/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("Boykisser/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("Boykisser/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("Boykisser/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("Boykisser/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("Boykisser/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.Astolfo = Utility.AddImage("Boykisser/Assets/UI/Astolfo.png", "https://i.imgur.com/T20cWY9.png")
        Library.Theme.Aiko = Utility.AddImage("Boykisser/Assets/UI/Aiko.png", "https://i.imgur.com/1gRIdko.png")
